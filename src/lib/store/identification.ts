...
export const typeOptions = [
	...
	{
		key: ENUM_IDENTIFICATION_TYPE.travel_document,
		label: ENUM_IDENTIFICATION_TYPE_LABEL.travel_document
	},
	{
		key: ENUM_IDENTIFICATION_TYPE.driver_licence,
		label: ENUM_IDENTIFICATION_TYPE_LABEL.driver_licence
	}
];
